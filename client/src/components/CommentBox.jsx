...
const CommentBox = ({ selectedBlog }) => {
    ...
    useEffect(() => {
        const getAllCommentsOfBlog = async () => {
            try {
                const res = await axios.get(`http://localhost:3000/api/comment/${selectedBlog._id}/comment/all`)
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(`http://localhost:3000/api/comment/${selectedBlog._id}/create`, { content }, {
                headers: {
    ...
    const deleteComment = async (commentId) => {
        try {
            const res = await axios.delete(`http://localhost:3000/api/comment/${commentId}/delete`, {
                withCredentials: true
            })
            if (res.data.success) {
    ...
    const editCommentHandler = async (commentId) => {
        try {
            const res = await axios.put(
                `http://localhost:3000/api/comment/${commentId}/edit`,
